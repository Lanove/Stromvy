 ...
 * Wire.begin() method.
 ******************************************************************************/
void Eeprom24C04_16::initialize()
{
    Wire.begin();
}
 ...
 ******************************************************************************/
void Eeprom24C04_16::writeBytes(
    word address,
    word length,
    byte *p_data)
{
 ...
 * \param[in]   p_data  Data.
 ******************************************************************************/
void Eeprom24C04_16::writeBuffer(
    word address,
    byte length,
    byte *p_data)
{
 ...
 ******************************************************************************/
void Eeprom24C04_16::readBuffer(
    word address,
    byte length,
    byte *p_data)
{
